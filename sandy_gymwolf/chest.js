...
//   }
// }
// document.getElementById("content_div").addEventListener("click",function(){
//  let d= document.getElementById("z").innerHTML
//  console.log(d)
//    getdata(d)
// })
function any(){
...
let a=JSON.parse(localStorage.getItem("body_name"))
getdata(a)
function call(d){
